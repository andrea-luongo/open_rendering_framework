...
static __host__ __device__ __inline__ void __md5Hash(unsigned char* data, uint32_t length, uint32_t *a1, uint32_t *b1, uint32_t *c1, uint32_t *d1) {
...
static __host__ __device__ __inline__ float int_to_float01(uint32_t t)
{
	uint32_t res = t;
...
static __host__ __device__ __inline__ optix::uint4 rand_md5(const uint32_t base, const uint32_t scrambler)
{
...
static __host__ __device__ __inline__ optix::uint4 rand_md5(const optix::uint2& base, const uint32_t scrambler)
{
...
static __host__ __device__ __inline__ optix::uint4 rand_md5(const optix::uint3& base, const uint32_t scrambler)
{
...
static __host__ __device__ __inline__ optix::uint4 rand_md5(const optix::uint4& base, const uint32_t scrambler)
{
...
static __host__ __device__ __inline__ optix::float4 rand_md5_f(const uint32_t base, const uint32_t scrambler)
{
...
static __host__ __device__ __inline__ optix::float4 rand_md5_f(const optix::uint2& base, const uint32_t scrambler)
{
	optix::uint4 res = rand_md5(base, scrambler);
	return optix::make_float4(int_to_float01(res.x), int_to_float01(res.y), int_to_float01(res.z), int_to_float01(res.w));
}
static __host__ __device__ __inline__ optix::float4 rand_md5_f(const optix::uint3& base, const uint32_t scrambler)
{
	optix::uint4 res = rand_md5(base, scrambler);
	return optix::make_float4(int_to_float01(res.x), int_to_float01(res.y), int_to_float01(res.z), int_to_float01(res.w));
}
static __host__ __device__ __inline__ optix::float4 rand_md5_f(const optix::uint4& base, const uint32_t scrambler)
{
	optix::uint4 res = rand_md5(base, scrambler);
	return optix::make_float4(int_to_float01(res.x), int_to_float01(res.y), int_to_float01(res.z), int_to_float01(res.w));
}
